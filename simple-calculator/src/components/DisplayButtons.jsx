...
function DisplayButtons({handleClick, clear, backSpace}) {
  return (
    <div className="grid grid-cols-4 gap-3">
      ...
      <Buttons className="bg-gray-600 p-4 text-white text-xl rounded-md" name={"%"} value={"%"} handleClick={handleClick} />
      <Buttons className="bg-yellow-500 p-4 text-white text-xl rounded-md" name={"÷"} value={"÷"} handleClick={handleClick} />
